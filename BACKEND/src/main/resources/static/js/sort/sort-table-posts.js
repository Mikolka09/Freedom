...
function printTablePosts(data) {
    ...
    if (data != null) {
        for (let i = 0; i < data.length; i++) {
            ...
            td4.innerText = data[i].category.status !== "DELETED" ? data[i].category.name : "NULL";
            ...
            td6.innerText = data[i].likes === null ? 0 : data[i].likes;
            let td7 = document.createElement('td');
            td7.innerText = data[i].comments.length;
            let td8 = document.createElement('td');
            td8.innerText = data[i].status;
            let td9 = document.createElement('td');
            td9.innerText = correctDate(data[i].createdAt);
            let td10 = document.createElement('td');
            td10.innerText = correctDate(data[i].updatedAt);
